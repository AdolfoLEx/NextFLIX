  ...
  return (
    <div className="min-h-screen bg-gray-600 p-8">
      ...
      <div className="mb-6 flex justify-end pl-6">
        <SerieFormModal
          trigger={
            <button className="flex flex-row gap-2 rounded bg-green-700 px-4 py-2 text-white transition hover:bg-green-600">
              <PlusIcon />
              Agregar Serie
            </button>
          }
            ...
            actions={
              <div className="flex w-full items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  <SerieFormModal
                    serie={serie} // Prop enviada correctamente para habilitar la edición
                    trigger={
                      <button
                        type="button"
